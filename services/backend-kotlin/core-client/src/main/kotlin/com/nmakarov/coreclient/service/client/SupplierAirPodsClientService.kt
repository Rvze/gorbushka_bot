...
import com.nmakarov.coreclient.util.toAirPodsBotUserUpdateRequestAirPodsDto
...
class SupplierAirPodsClientService(
    private val supplierAirPodsApi: com.nmakarov.coreclient.api.feign.SupplierAirPodsApi
) {
    ...
    fun updateAirPods(supplierId: Long, airpods: List<AirPods>, currentRetryCount: Int = 0) {
        try {
            supplierAirPodsApi.v1AirPodsBotUserUpdate(
                request = com.nmakarov.coreclient.api.feign.dto.airpods.AirPodsBotUserUpdateRequest(
    ...
    fun airPodsFindBest(
        ...
        return try {
            val requestBody =
                com.nmakarov.coreclient.api.feign.dto.airpods.AirPodsFindBestRequest(model, color, country)
    ...
    private fun com.nmakarov.coreclient.api.feign.dto.airpods.AirPodsFindBestResponseAirPodsDto.toAirPods(): AirPods {
